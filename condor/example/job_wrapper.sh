...
#
# Arguments: $1 = analysis config (relative to repo root), $2 = chunk id.
#
...
echo "[job] repo=$REPO_ROOT config=$CONFIG chunk=$CHUNK"
...
bash scripts/run_kinfit_assignment.sh --config "$CONFIG" --chunk "$CHUNK"
